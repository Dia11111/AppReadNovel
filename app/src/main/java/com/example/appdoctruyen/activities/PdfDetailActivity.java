...
import com.example.appdoctruyen.adapters.AdapterComment;
...
import com.example.appdoctruyen.databinding.DialogCommentAddBinding;
...
public class PdfDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addCommentsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot ds: snapshot.getChildren()){
                            //get data as model, spelling of cariables in model be as some as in firebase
